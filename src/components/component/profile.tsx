...
* @see https://v0.dev/t/hj26GnHwwHI
                ...
                <div className="grid gap-3">
                  <div className="grid grid-cols-[1fr_auto] items-center gap-4">
                    <div className="grid gap-1">
                      ...
                      <p className="text-gray-500 dark:text-gray-400">$15,000 | 24 months</p>
                    </div>
                  ...
                  <div className="grid grid-cols-[1fr_auto] items-center gap-4">
                    <div className="grid gap-1">
                      ...
                      <p className="text-gray-500 dark:text-gray-400">$25,000 | 36 months</p>
                    </div>
                    <Button size="sm" variant="outline">
                      View
                    </Button>
                ...
                <div className="grid gap-3">
                  <div className="grid grid-cols-[1fr_auto] items-center gap-4">
                    <div className="grid gap-1">
                      ...
                      <p className="text-gray-500 dark:text-gray-400">$50,000 | 60 months</p>
                    </div>
                    <Button size="sm" variant="outline">
                      View
                    </Button>
                  ...
                  <div className="grid grid-cols-[1fr_auto] items-center gap-4">
                    <div className="grid gap-1">
                      ...
                      <p className="text-gray-500 dark:text-gray-400">$10,000 | 12 months</p>
                    </div>
                    <Button size="sm" variant="outline">
                      View
                    </Button>
                ...
                <div className="grid gap-3">
                  <div className="grid grid-cols-[1fr_auto] items-center gap-4">
                    <div className="grid gap-1">
                      ...
                      <p className="text-gray-500 dark:text-gray-400">$30,000 | 48 months</p>
                    </div>
                    <Button size="sm" variant="outline">
                      View
                    </Button>
